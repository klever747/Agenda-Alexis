                ...
                <div class="card card-user">
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5" >
                        <div class="form-group">
                          <h5><b>Tiene empleados que superan la F.B?</b></h5>
                      ...
                      <div class="col-sm-5" >
                        <div class="form-group">
                          <h5><b>RUC deduce GP (Ventas&lt;100mil)</b></h5>
                          <select class="custom-select" id="txtRucDeduce" name="txtRucDeduce">
                            <option value="SI">SI</option>
                            <option value="NO">NO</option>
                          </select>
                        </div>
                      ...
                      <div class="col-sm-4" >
                        <div class="form-group">
                          <h5><b>Contrata auditoria?</b></h5>
                          <select class="custom-select" id="txtAuditoria" name="txtAuditoria">
                            <option value="SI">SI</option>
                            <option value="NO">NO</option>
                          </select>
                        </div>
                    ...
                    <div class="row">
                      <div class="update ml-auto mr-auto">
                        <button type="submit"  class="btn btn-primary btn-round crear_generales">Guardar</button>
                      </div>
                    </div>
                  </div>
            </div>
          ...
          <div class="tab-pane" role="tabpanel" id="menu2">
              <div class="card card-user">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="submit" class="btn btn-primary btn-round crear_claves">Guardar</button>
                    </div>
                  </div>
                </div>
          </div>
            ...
            <div class="tab-pane active" role="tabpanel" id="menu1">
                <div class="card card-user">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="update ml-auto mr-auto">
                        <button type="submit"  class="btn btn-primary btn-round actualizar_generales">Guardar</button>
                      </div>
                    </div>
                  </div>
            </div>
