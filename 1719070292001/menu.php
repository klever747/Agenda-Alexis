...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="">
                <a href="actividades.php"><i class="fa fa-list-ol"></i> <span class="nav-label">Directorio</span></a>
            </li>
            <li class="">
                <a href="calendario.php"><i class="fa fa-calendar"></i> <span class="nav-label">Agenda Empresarial</span></a>
            </li>
            <li class="">
                <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Configuraciones</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="clientes.php"><i class="fa fa-users"></i>Clientes</a></li>
                    <li><a href="usuarios.php"><i class="fa fa-user-o"></i>Usuarios</a></li>
                    <li><a href="admin_actividades.php"><i class="fa fa-files-o"></i>Actividades</a></li>
                </ul>
            </li>
            <?php
            if($suscrito=="NO"){
                ...
                <li class="special_link">
                  <a href="#" data-toggle="modal" data-target="#myModal5"><i class="fa fa-bell-o"></i> <span class="nav-label">SUSCRIBIRSE</span></a>
                </li>
                <?php
            }else{
                ?>
                <li class="">
                  <a href="repositorio.php"><i class="fa fa-file-pdf-o"></i> <span class="nav-label">Repositorio</span></a>
                </li>
                <?php
            }
            ?>
            ...
            <li class="">
                <a href="crear_agenda.php"><i class="fa fa-file"></i> <span class="nav-label">Tareas</span></a>
            </li>
            <li class="">
